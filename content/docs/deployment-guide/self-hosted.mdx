...
<VideoPlayer videoPath="/docs-videos/8-motia-self-hosting.mp4" gifPath="/docs-videos/gifs/8-motia-self-hosting.gif" title="Self-Hosting & Deployment" className="mb-8" />

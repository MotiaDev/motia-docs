...
<VideoPlayer videoPath="https://assets.motia.dev/videos/mp4/site/v1/4-motia-workbench.mp4" gifPath="https://assets.motia.dev/images/gifs/v1/4-motia-workbench.gif" title="Using the Workbench" className="mb-8" />

...
<VideoPlayer videoPath="/docs-videos/2-motia-overview-core-concepts.mp4" gifPath="/docs-videos/gifs/2-motia-overview-core-concepts.gif" title="Overview & Core Concepts" className="mb-8" />

...
<div className="my-8">![ChessArena AI development console](./../img/chessarena-workbench.png)</div>
...
<Tabs items={['models-api', 'create-game', 'move-evaluation', 'ai-player', 'streams', 'auth']}>
  <Tab value="models-api">
    ...
    export const config = {
      ...
      triggers: [{ type: 'api', path: '/chess/models', method: 'GET' }],
      enqueues: [],
      flows: ['chess'],
      responseSchema: {
  ...
  <Tab value="create-game">
    ...
    export const config = {
      ...
      triggers: [{ type: 'api', path: '/chess/create-game', method: 'POST' }],
  ...
  <Tab value="auth">
    ...
    export const config = {
      ...
      triggers: [{ type: 'api', path: '/auth/login', method: 'POST' }],
...
2. Go to [Motia Cloud -> Import from development console](https://motia.cloud)

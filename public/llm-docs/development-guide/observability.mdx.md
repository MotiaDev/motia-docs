...
<VideoPlayer videoPath="https://assets.motia.dev/videos/mp4/site/v1/5-motia-logging.mp4" gifPath="https://assets.motia.dev/images/gifs/v1/5-motia-logging.gif" title="Logging & Debugging" className="mb-8" />
...
![iii Console Logs](./../img/build-your-first-app/ai-enrichment-logs.png)
...
2. **Open the iii console** at [http://localhost:3000](http://localhost:3000)
...
- **Check the iii console** - Visual debugging is easier
